...
spir_basis* basis_fermionic = spir_basis_new_with_sve(SPIR_STATISTICS_FERMIONIC, beta, omega_max, logistic_kernel, sve_logistic, &status);
assert(status == SPIR_COMPUTATION_SUCCESS);
assert(basis_fermionic != NULL);

spir_basis* basis_bosonic = spir_basis_new_with_sve(SPIR_STATISTICS_BOSONIC, beta, omega_max, logistic_kernel, sve_logistic, &status);
assert(status == SPIR_COMPUTATION_SUCCESS);
...
spir_basis* basis_regularized = spir_basis_new_with_sve(SPIR_STATISTICS_BOSONIC, beta, omega_max, regularized_kernel, sve_regularized, &status);
assert(status == SPIR_COMPUTATION_SUCCESS);
