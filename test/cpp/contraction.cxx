...
template<typename T>
Matrix<T, Dynamic, Dynamic> create_random_matrix(int rows, int cols, std::mt19937& gen);

// Specialization for double
template<>
Matrix<double, Dynamic, Dynamic> create_random_matrix<double>(int rows, int cols, std::mt19937& gen) {
...
template<>
Matrix<std::complex<double>, Dynamic, Dynamic> create_random_matrix<std::complex<double>>(int rows, int cols, std::mt19937& gen) {
...
TEST_CASE("_gemm_inplace basic functionality", "[contraction]") {
    ...
    SECTION("double * double -> double") {
        ...
        Matrix<double, Dynamic, Dynamic> A = create_random_matrix<double>(M, K, gen);
        Matrix<double, Dynamic, Dynamic> B = create_random_matrix<double>(K, N, gen);
        Matrix<double, Dynamic, Dynamic> C_expected = A * B;
        Matrix<double, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
        
        // Test _gemm_inplace
        _gemm_inplace<double, double, double>(A.data(), B.data(), C_actual.data(), M, N, K);
    ...
    SECTION("complex<double> * complex<double> -> complex<double>") {
        ...
        Matrix<std::complex<double>, Dynamic, Dynamic> A = create_random_matrix<std::complex<double>>(M, K, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> B = create_random_matrix<std::complex<double>>(K, N, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> C_expected = A * B;
        Matrix<std::complex<double>, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
        
        // Test _gemm_inplace
        _gemm_inplace<std::complex<double>, std::complex<double>, std::complex<double>>(
    ...
    SECTION("double * complex<double> -> complex<double>") {
        ...
        Matrix<double, Dynamic, Dynamic> A = create_random_matrix<double>(M, K, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> B = create_random_matrix<std::complex<double>>(K, N, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> C_expected = A.cast<std::complex<double>>() * B;
        Matrix<std::complex<double>, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
    ...
    SECTION("complex<double> * double -> complex<double>") {
        ...
        Matrix<std::complex<double>, Dynamic, Dynamic> A = create_random_matrix<std::complex<double>>(M, K, gen);
        Matrix<double, Dynamic, Dynamic> B = create_random_matrix<double>(K, N, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> C_expected = A * B.cast<std::complex<double>>();
        Matrix<std::complex<double>, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
...
TEST_CASE("_gemm_inplace_t basic functionality", "[contraction]") {
    ...
    SECTION("double * double -> double (B transposed)") {
        ...
        Matrix<double, Dynamic, Dynamic> A = create_random_matrix<double>(M, K, gen);
        Matrix<double, Dynamic, Dynamic> B = create_random_matrix<double>(N, K, gen); // Note: N rows, K cols
        Matrix<double, Dynamic, Dynamic> C_expected = A * B.transpose();
        Matrix<double, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
        
        // Test _gemm_inplace_t
        _gemm_inplace_t<double, double, double>(A.data(), B.data(), C_actual.data(), M, N, K);
        
        REQUIRE(matrices_approximately_equal(C_expected, C_actual));
    }
    
    SECTION("complex<double> * complex<double> -> complex<double> (B transposed)") {
        int M = 3, N = 4, K = 2;
        
        Matrix<std::complex<double>, Dynamic, Dynamic> A = create_random_matrix<std::complex<double>>(M, K, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> B = create_random_matrix<std::complex<double>>(N, K, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> C_expected = A * B.transpose();
        Matrix<std::complex<double>, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
        
        // Test _gemm_inplace_t
        _gemm_inplace_t<std::complex<double>, std::complex<double>, std::complex<double>>(
            A.data(), B.data(), C_actual.data(), M, N, K);
    ...
    SECTION("double * complex<double> -> complex<double> (B transposed)") {
        ...
        Matrix<double, Dynamic, Dynamic> A = create_random_matrix<double>(M, K, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> B = create_random_matrix<std::complex<double>>(N, K, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> C_expected = A.cast<std::complex<double>>() * B.transpose();
        Matrix<std::complex<double>, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
    ...
    SECTION("complex<double> * double -> complex<double> (B transposed)") {
        ...
        Matrix<std::complex<double>, Dynamic, Dynamic> A = create_random_matrix<std::complex<double>>(M, K, gen);
        Matrix<double, Dynamic, Dynamic> B = create_random_matrix<double>(N, K, gen);
        Matrix<std::complex<double>, Dynamic, Dynamic> C_expected = A * B.transpose().cast<std::complex<double>>();
        Matrix<std::complex<double>, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
...
TEST_CASE("_gemm_inplace edge cases", "[contraction]") {
    ...
    SECTION("1x1 matrices") {
        ...
        _gemm_inplace<double, double, double>(A.data(), B.data(), C_actual.data(), 1, 1, 1);
...
TEST_CASE("_gemm_inplace_t edge cases", "[contraction]") {
    ...
    SECTION("1x1 matrices") {
        ...
        _gemm_inplace_t<double, double, double>(A.data(), B.data(), C_actual.data(), 1, 1, 1);
...
TEST_CASE("_gemm_inplace numerical accuracy", "[contraction]") {
    ...
    SECTION("Identity matrix multiplication") {
        int size = 4;
        Matrix<double, Dynamic, Dynamic> A = Matrix<double, Dynamic, Dynamic>::Identity(size, size);
        Matrix<double, Dynamic, Dynamic> B = create_random_matrix<double>(size, size, gen);
        Matrix<double, Dynamic, Dynamic> C_expected = A * B;
        Matrix<double, Dynamic, Dynamic> C_actual(size, size);
        C_actual.setZero();
        
        _gemm_inplace<double, double, double>(A.data(), B.data(), C_actual.data(), size, size, size);
    ...
    SECTION("Zero matrix multiplication") {
        int M = 3, N = 4, K = 2;
        Matrix<double, Dynamic, Dynamic> A = Matrix<double, Dynamic, Dynamic>::Zero(M, K);
        Matrix<double, Dynamic, Dynamic> B = create_random_matrix<double>(K, N, gen);
        Matrix<double, Dynamic, Dynamic> C_expected = A * B;
        Matrix<double, Dynamic, Dynamic> C_actual(M, N);
        C_actual.setZero();
...
TEST_CASE("_gemm_inplace_t numerical accuracy", "[contraction]") {
    ...
    SECTION("Identity matrix multiplication with transpose") {
        ...
        _gemm_inplace_t<double, double, double>(A.data(), B.data(), C_actual.data(), size, size, size);
