...
template<>
inline void _gemm_blas_impl_transpose<std::complex<double>, std::complex<double>, std::complex<double>>(const std::complex<double>* A, const std::complex<double>* B, std::complex<double>* C, int M, int N, int K) {
    const std::complex<double> alpha(1.0);
    const std::complex<double> beta(0.0);
...
inline void _gemm_blas_impl_transpose<double, std::complex<double>, std::complex<double>>(const double* A, const std::complex<double>* B, std::complex<double>* C, int M, int N, int K) {
    // Use Eigen's internal gemm - it's fast enough and much simpler
    Eigen::Map<const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>> A_map(A, M, K);
    Eigen::Map<const Eigen::Matrix<std::complex<double>, Eigen::Dynamic, Eigen::Dynamic>> B_map(B, N, K);
    Eigen::Map<Eigen::Matrix<std::complex<double>, Eigen::Dynamic, Eigen::Dynamic>> C_map(C, M, N);
...
inline void _gemm_blas_impl_transpose<std::complex<double>, double, std::complex<double>>(const std::complex<double>* A, const double* B, std::complex<double>* C, int M, int N, int K) {
    // Use Eigen's internal gemm - it's fast enough and much simpler
    Eigen::Map<const Eigen::Matrix<std::complex<double>, Eigen::Dynamic, Eigen::Dynamic>> A_map(A, M, K);
    Eigen::Map<const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>> B_map(B, N, K);
    Eigen::Map<Eigen::Matrix<std::complex<double>, Eigen::Dynamic, Eigen::Dynamic>> C_map(C, M, N);
