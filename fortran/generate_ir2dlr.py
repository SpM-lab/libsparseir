...
def generate_ir2dlr_function(ndim, input_type, output_type):
    ...
    function = f"""SUBROUTINE ir2dlr_{func_suffix}_{ndim}d(obj, target_dim, arr, res)
  ...
  IF (status_c /= 0) THEN
    CALL errore('ir2dlr_{func_suffix}_{ndim}d', 'Error converting IR to DLR', status_c)
  ENDIF
END SUBROUTINE"""
